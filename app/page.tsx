      ...
      <div className="max-w-7xl 2x:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-6xl font-extrabold text-white tracking-tight mb-6 leading-[1.1]">
              Premium Laundry,<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-[100%] sm:w-auto mb-10">
              <button className="py-2 md:px-8 md:py-4 bg-[#E5BD43] text-[#0A121B] rounded-full font-bold text-lg shadow-[0_0_20px_rgba(229,189,67,0.3)] hover:shadow-[0_0_30px_rgba(229,189,67,0.5)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 group">
                Book Pickup <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="py-2 md:px-8 md:py-4 bg-transparent border border-[#6A6F76] text-[#F0F6FC] rounded-full font-bold text-lg hover:border-[#F0F6FC] hover:bg-[#F0F6FC]/5 transition-all flex items-center justify-center gap-2">
                View Pricing
              </button>
            </div>
